...
function AppNavigator() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: h.background }}>
      <SafeAreaProvider>
          ...
          <NavigationThemeProvider value={navigationTheme}>
            ...
            >
              ...
              <Stack.Screen
                ...
                options={({ route }) => ({
                  title:
                    (route.params as { name?: string } | undefined)?.name ??
                    "Chat",
                })}
              />
              ...
              <Stack.Screen
                ...
                options={{ title: 'Choose a username', gestureEnabled: false, headerBackVisible: false }}
              />
            </Stack>
